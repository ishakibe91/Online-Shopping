...
Statement stmt4 = con.createStatement();
	String category1 = "Battery";
	   ...
	   String description_name11="" , description_value11="",description_name22="" , description_value22="",imge1="",prod_name1="";
	    int price1=0;
		 ResultSet rs4  = stmt4.executeQuery(query3);
		 while(rs4.next())
{

	prod_name1=rs4.getString("prod_name");
  imge1=rs4.getString("image");  
  description_name11=rs4.getString("description_name1");
  description_value11=rs4.getString("description_value1");
  description_name22=rs4.getString("description_name2");
  description_value22=rs4.getString("description_value2");
	price1=rs4.getInt("price");	
  ...
  <div class="product-list">
    ...
    <div class="product-item">
      <!-- Product image -->
	  <form method=post action="http://localhost:8080/examples/Online_Shop/OrderServlet.jsp" style="COLOR: black">
      <a href="Samram2.html"><img src="<%//=imge%>" alt="Product 1"></a>
      <!-- Product specifications -->
      <div class="product-specs">
        <h2><%//=prod_name%></h2>
        <ul>
          <b><li>Price: <%//=price%></li></b>
		  <li><%//=description_name11%>: <%//=description_value11%></li><br /> 
          <li><%//=description_name22%>:<%//=description_value22%></li>
	  ...
	  <!--<font size="4" color="seagreen">Enter Quantity</font>&nbsp;
                        <INPUT type = "textbox" align=right name=HT_ITEM_QTY style="HEIGHT: 22px; WIDTH: 38px"  value=1>&nbsp;&nbsp;
                        <INPUT style="HEIGHT: 24px; WIDTH: 48px" type=submit value=Order  src="images/computer1jpg.jpg" id=submit2 name=submit1>
		 		  <INPUT name=HT_ITEM_CODE width="38px" type=hidden value=7005 style="HEIGHT: 22px; WIDTH: 42px"> -->
	  </form>
    </div>
	<%
	rs3.next();
  ...
  description_value2=rs3.getString("description_value2");
    ...
    <div class="product-item">
	  ...
	  <font size="4" color="seagreen">Enter Quantity</font>&nbsp;
                        <INPUT type = "textbox" align=right name=HT_ITEM_QTY style="HEIGHT: 22px; WIDTH: 38px"  value=1>&nbsp;&nbsp;
                        <INPUT style="HEIGHT: 24px; WIDTH: 48px" type=submit value=Order  src="images/computer1jpg.jpg" id=submit2 name=submit1>
		 		  <INPUT name=HT_ITEM_CODE width="38px" type=hidden value=7006 style="HEIGHT: 22px; WIDTH: 42px">
	  </form>
    </div>
    <hr>
    <!-- Individual product item -->
    <div class="product-item">
      <!-- Product image -->
	  <form method=post action="http://localhost:8080/examples/Online_Shop/OrderServlet.jsp" style="COLOR: black">
      <a href="Iram2.html"><img src="<%=imge%>" alt="Product 3"></a>
      <!-- Product specifications -->
      <div class="product-specs">
        <h2><%=prod_name%></h2>
        <ul>
	  ...
	  <font size="4" color="seagreen">Enter Quantity</font>&nbsp;
                        <INPUT type = "textbox" align=right name=HT_ITEM_QTY style="HEIGHT: 22px; WIDTH: 38px"  value=1>&nbsp;&nbsp;
                        <INPUT style="HEIGHT: 24px; WIDTH: 48px" type=submit value=Order  src="images/computer1jpg.jpg" id=submit2 name=submit1>
		 		  <INPUT name=HT_ITEM_CODE width="38px" type=hidden value=7007 style="HEIGHT: 22px; WIDTH: 42px">
	  </form>
    </div>
	<%
	rs3.next();
  ...
  description_value2=rs3.getString("description_value2");
    ...
    <div class="product-item">
      <!-- Product image -->
	  <form method=post action="http://localhost:8080/examples/Online_Shop/OrderServlet.jsp" style="COLOR: black">
      <a href="XMS32.html"><img src="<%=imge%>" alt="Product 4"></a>
      <!-- Product specifications -->
      <div class="product-specs">
		<h2><%=prod_name%></h2>
        <ul>
	  ...
	  <font size="4" color="seagreen">Enter Quantity</font>&nbsp;
                        <INPUT type = "textbox" align=right name=HT_ITEM_QTY style="HEIGHT: 22px; WIDTH: 38px"  value=1>&nbsp;&nbsp;
                        <INPUT style="HEIGHT: 24px; WIDTH: 48px" type=submit value=Order  src="images/computer1jpg.jpg" id=submit2 name=submit1>
		 		  <INPUT name=HT_ITEM_CODE width="38px" type=hidden value=7008 style="HEIGHT: 22px; WIDTH: 42px">
	  </form>
    </div>
    <!-- Add more product items here -->
  </div>
