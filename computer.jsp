...
//		out.println(cnt);
        ...
        <div class="product-specs">
            ...
            <ul>
				...
				<li><%= description_name3 %>: <%= description_value3 %></li><br/>
                <li><%= description_name4 %>: <%= description_value4 %></li>
            </ul
			><font size="4" color="seagreen">Enter Quantity</font>&nbsp;
                        <INPUT type = "textbox" align=right name=HT_ITEM_QTY style="HEIGHT: 22px; WIDTH: 38px"  value=1>&nbsp;&nbsp;                       <INPUT style="HEIGHT: 24px; WIDTH: 48px" type=submit value=Order class="order-btn" src="<%= imge%>" id=submit2 name=submit1>
...
<%
    ...
    cnt++;
    if (cnt % 4 == 0) { // Close and open a new row after every 4 products, but not after the last set
