	...
	<form method=post action="http://localhost:8080/examples/Online_Shop/OrderServlet.jsp" style="COLOR: black">
        ...
        <div class="product-specs">
			...
			><font size="4" color="seagreen">Enter Quantity</font>&nbsp;
                        <INPUT type = "textbox" align=right name=HT_ITEM_QTY style="HEIGHT: 22px; WIDTH: 38px"  value=1>&nbsp;&nbsp;                       <INPUT style="HEIGHT: 24px; WIDTH: 48px" type=submit value=Order class="order-btn" src="images/computer1jpg.jpg" id=submit2 name=submit1>
